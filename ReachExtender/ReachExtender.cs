...
namespace ReachExtender {
    ...
    public class ReachExtenderPlugin : BaseUnityPlugin {
        ...
        void Awake() {
            ...
            SphereCastRadius = Config.Bind("Loot Distances", "Sphere Cast Radius.", 0.1f, new ConfigDescription("Set to 0 to disable feature.", new AcceptableValueRange<float>(0f, 5f)));
            ShowSphereCastDebug = Config.Bind("Loot Distances", "Show debug sphere.", false, new ConfigDescription("Shows the radius of the sphere used for casting."));
