...
namespace ReachExtender {
    ...
    public class ReachExtenderPlugin : BaseUnityPlugin {
        ...
        void Awake() {
            ...
            SphereCastRadius = Config.Bind("Sphere Casting", "Sphere Cast Radius.", 0.2f, new ConfigDescription("Set to 0 to disable feature.", new AcceptableValueRange<float>(0f, 2f)));
